...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Proposal Store</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
 ...
 * </p>
 * <ul>
 *   <li>{@link kcl.ac.uk.xtext.annotationsStores.ProposalStore#getName <em>Name</em>}</li>
 ...
 * @generated
 */
public interface ProposalStore extends EObject
{
  /**
   ...
   * @see #setName(String)
   * @see kcl.ac.uk.xtext.annotationsStores.AnnotationsStoresPackage#getProposalStore_Name()
   * @model
   * @generated
   */
  String getName();
  ...
  /**
   * Sets the value of the '{@link kcl.ac.uk.xtext.annotationsStores.ProposalStore#getName <em>Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setScope(Scope)
   * @see kcl.ac.uk.xtext.annotationsStores.AnnotationsStoresPackage#getProposalStore_Scope()
  ...
  /**
   * Sets the value of the '{@link kcl.ac.uk.xtext.annotationsStores.ProposalStore#getScope <em>Scope</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setFocus(Focus)
   * @see kcl.ac.uk.xtext.annotationsStores.AnnotationsStoresPackage#getProposalStore_Focus()
   * @model containment="true"
   * @generated
   */
  Focus getFocus();
  ...
  /**
   * Sets the value of the '{@link kcl.ac.uk.xtext.annotationsStores.ProposalStore#getFocus <em>Focus</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see kcl.ac.uk.xtext.annotationsStores.AnnotationsStoresPackage#getProposalStore_Content()
   * @model
   * @generated
   */
  String getContent();
  ...
  /**
   * Sets the value of the '{@link kcl.ac.uk.xtext.annotationsStores.ProposalStore#getContent <em>Content</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
