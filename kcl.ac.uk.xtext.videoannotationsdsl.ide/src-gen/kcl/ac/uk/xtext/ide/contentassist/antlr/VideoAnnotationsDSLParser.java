		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getAnnotationAccess().getIdAssignment_6(), "rule__Annotation__IdAssignment_6");
					...
					put(grammarAccess.getAnnotationAccess().getTargetAssignment_18(), "rule__Annotation__TargetAssignment_18");
