 ...
 * </p>
 * <ul>
 *   <li>{@link kcl.ac.uk.xtext.videoAnnotationsDSL.Focus#getFocus <em>Focus</em>}</li>
 * </ul>
 *
 * @see kcl.ac.uk.xtext.videoAnnotationsDSL.VideoAnnotationsDSLPackage#getFocus()
 * @model
 * @generated
 */
public interface Focus extends EObject
{
   ...
   * @see #setFocus(String)
   * @see kcl.ac.uk.xtext.videoAnnotationsDSL.VideoAnnotationsDSLPackage#getFocus_Focus()
   * @model
   * @generated
   */
  String getFocus();
  ...
  /**
   * Sets the value of the '{@link kcl.ac.uk.xtext.videoAnnotationsDSL.Focus#getFocus <em>Focus</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
