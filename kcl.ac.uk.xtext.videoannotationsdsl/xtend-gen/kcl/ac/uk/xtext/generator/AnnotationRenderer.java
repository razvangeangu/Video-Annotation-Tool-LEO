...
public class AnnotationRenderer {
  ...
  public CharSequence renderWithoutTimes(final Annotation annotation) {
    ...
    String _comment = annotation.getComment();
    boolean _notEquals_2 = (!Objects.equal(_comment, null));
    if (_notEquals_2) {
      StringConcatenation _builder_3 = new StringConcatenation();
      _builder_3.append(" ");
      _builder_3.append("#\"");
      String _comment_1 = annotation.getComment();
      _builder_3.append(_comment_1, " ");
      _builder_3.append("\"#");
  ...
  public CharSequence renderWithoutComment(final Annotation annotation) {
    StringConcatenation _builder = new StringConcatenation();
    _builder.append("from ");
    Time _fromTime = annotation.getFromTime();
    int _sec = _fromTime.getSec();
